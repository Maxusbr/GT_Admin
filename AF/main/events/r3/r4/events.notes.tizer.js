(function () {
    ...
    function eventNotesTizerController($rootScope, $cookieStore, $scope, $filter, personService) {
        var vm = this;
    ...
    eventNotesTizerController.$inject = ['$rootScope', '$cookieStore', '$scope', '$filter', 'personService'];
})();